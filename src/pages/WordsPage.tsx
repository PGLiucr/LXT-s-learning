...
import { Plus, Search, Trash2, Edit2, Volume2, Filter, Calendar, Book, CheckSquare, GraduationCap, X, Check } from 'lucide-react'
...
const WordsPage = () => {
  ...
  const handleImportCET6 = async () => {
    ...
    const wordsToImport = CET6_SAMPLE.filter(w => selectedLibraryWords.includes(w.english_word))
